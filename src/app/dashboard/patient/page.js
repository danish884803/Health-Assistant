        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                {loadingAppointments ? (
                  ...
                  <div className="space-y-4">
                    {appointments.map(app => (
                      <div
                        key={app._id}
                        className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 p-4 bg-slate-50 rounded-2xl border-l-4 border-teal-500"
                      >
            ...
            <div className="space-y-6">
              ...
              {/* MAP PROMO */}
              <div className="rounded-3xl p-6 sm:p-8 text-white bg-gradient-to-br from-teal-600 to-emerald-500 shadow-xl">
