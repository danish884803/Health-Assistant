...
//         </span>
//         <button
//           onClick={() => viewPatientDetails(slot._id)}
//           className="w-9 h-9 rounded-lg border bg-white flex items-center justify-center hover:bg-blue-500 hover:text-white transition-colors"
...
//               />
//               <textarea
//                 className="w-full border rounded-xl p-3 focus:ring-2 focus:ring-teal-500 outline-all transition-all"
//                 rows={2}
...
export default function DoctorDashboard() {
  ...
  // FIXED: Show loading spinner instead of returning null
  if (loading) {
    return (
