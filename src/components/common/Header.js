...
//           <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-teal-500 to-emerald-400 flex items-center justify-center text-white font-bold text-sm shadow-sm">
//             SK
//           </div>
...
//             Home
//           </Link>
//           <Link href="/departments" className="hover:text-teal-600 transition">
//             Departments
//           </Link>
//           <Link href="/services" className="hover:text-teal-600 transition">
//             Services
//           </Link>
//           <Link href="/map" className="hover:text-teal-600 transition">
//             Hospital Map
//           </Link>
...
//           {/* Language */}
//           <button className="flex items-center gap-2 px-4 py-2 rounded-full border border-teal-500 text-teal-600 text-sm hover:bg-teal-50 transition">
//             🌐 العربية
//           </button>
...
//           <Link
//             href="/login"
//             className="px-4 py-2 rounded-full border border-teal-500 text-teal-600 text-sm hover:bg-teal-50 transition"
//           >
//             Login
//           </Link>
...
//           <Link
//             href="/appointments"
//             className="px-5 py-2 rounded-full text-sm font-medium text-white bg-gradient-to-r from-teal-500 to-emerald-400 shadow-md hover:opacity-90 transition"
//           >
//             Book Appointment
//           </Link>
//         </div>
...
//           <Link href="/departments" className="hover:text-teal-600 transition">Departments</Link>
//           <Link href="/services" className="hover:text-teal-600 transition">Services</Link>
//           <Link href="/map" className="hover:text-teal-600 transition">Hospital Map</Link>
...
//                 <Link
//                   href="/register"
//                   className="px-4 py-2 rounded-full border border-emerald-500 text-emerald-600 text-sm hover:bg-emerald-50 transition"
//                 >
//                   Register
//                 </Link>
//               </>
...
//                 <button
//                   onClick={logout}
//                   className="px-4 py-2 rounded-full border border-red-500 text-red-600 text-sm hover:bg-red-50 transition flex items-center gap-1"
//                 >
//                   <LogOut size={14} />
//                   Logout
//                 </button>
